...
class Input:
    ...
    def __init__(self, **options):
        ...
        self.options = Config(options, ['x', '229'], ['y', '288'], ['font', 'pygame.font.Font(None, 32)'],
                              ['color', '(49, 182, 144)'], ['restricted', '\'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!"#$%&\\\'()*+,-./:;<=>?@[\]^_`{|}~\''],
                              ['maxlength', '-1'], ['prompt', '\'\''])
        self.x = self.options.x; self.y = self.options.y
        self.font = self.options.font
        self.color = (49, 182, 144) 
